...
public class IsPerfectSquareTests
{
    ...
    public void IsPerfectSquare_WithVariousInputs_ReturnsExpectedResult_FromSourceTests(int num, bool expected)
    {
        bool result = LiveCodingPractice.IsPerfectSquare(num);
